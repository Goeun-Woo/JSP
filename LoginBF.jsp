...
function check(){
	...
	else if(Login.pass.value.length<1){
		alert("비밀번호를 입력하세요");
		Login.pass.focus();
		return false;
	}
...
<table id="__01" width="1025" height="769" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td colspan="8">
			<img src="images\LoginBF_07.jpg" width="469" height="31" alt=""></td>
...
<Input type = 'text' maxlength=10 size=5 name="id">
</TD>
</TR>
<TR>
<TD bgcolor ='00b0f0' align ='right' >
...
<TD bgcolor ='00b0f0' align ='center'>
<Input type = 'text' maxlength=10 size=5 name="pass">
</TD>

<Input type = "radio" name="side" value="Manager">관리자
<Input type = "radio" name="side" value="Student">학생<br>


</TR>
</Table>

<bgcolor ='00b0f0' align ='left'>
<Input onclick='check()' type='button' value='로그인'>
<bgcolor ='00b0f0' >
<Font size ='1.5'>
<a href="Project3_1_0.jsp">[회원가입]</a></Font>
...
String strSQL="SELECT TOP 4 title From ExternalBoard Where writedate not in(select TOP 1 title From ExternalBoard order by writedate desc)order by num desc";
...
String strSQL2="SELECT TOP 3 title From AnnouncementBoard Where writedate not in(select TOP 1 title From AnnouncementBoard order by writedate desc)order by num desc";
...
String strSQL3="SELECT TOP 4 title From FreeBoard Where writedate not in(select TOP 1 title From FreeBoard order by writedate desc)order by num desc";
...
String strSQL4="SELECT TOP 4 title From NewsBoard Where writedate not in(select TOP 1 title From NewsBoard order by writedate desc)order by num desc";
...
<div id="studyGroupSub" >
	<a href="HansarangApply.jsp" onclick="MM_showHideLayers('apDiv1','','hide')" onmouseout="MM_showHideLayers('studyGroupSub','','hide')"><font color="White" size="1.9" face="맑은 고딕">한사랑</font></a>
	<a href="ModuriApply.jsp" onclick="MM_showHideLayers('apDiv1','','hide')" onmouseout="MM_showHideLayers('studyGroupSub','','hide')"><font color="White" size="1.9" face="맑은 고딕">모두리</font></a> 
	<a href="EBizenApply.jsp" onclick="MM_showHideLayers('apDiv1','','hide')" onmouseout="MM_showHideLayers('studyGroupSub','','hide')"><font color="White" size="1.9" face="맑은 고딕">E-Bizen</font></a> 
	<a href="ItisApply.jsp" onclick="MM_showHideLayers('apDiv1','','hide')" onmouseout="MM_showHideLayers('studyGroupSub','','hide')"><font color="White" size="1.9" face="맑은 고딕">ITIS</font></a>  
	<a href="MisaApply.jsp" onclick="MM_showHideLayers('apDiv1','','hide')" onmouseout="MM_showHideLayers('studyGroupSub','','hide')"><font color="White" size="1.9" face="맑은 고딕">MISA</a></font></div>
