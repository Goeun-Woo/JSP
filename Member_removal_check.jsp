	  ...
	  <td rowspan="5">&nbsp;</td>
		...
		<td colspan="2" rowspan="3" align="center" valign="top">
			...
			<div id="StudyGroupLeftMenu"><font size="2" face="맑은 고딕" color="White">
			  ...
			  <input type = "submit" class="buttonstyle" value = "회원정보수정"></form></a></p>
...
<Font size ='2' color="white" face="맑은고딕">ID: </Font>
</TD>
...
<TR>
<TD bgcolor ='00b0f0' align ='right'>
<Font size ='2' color="white" face="맑은고딕">비밀번호: </Font>
</TD>
<TD bgcolor ='00b0f0' align ='center'>
...
<TR><font size="2" face="맑은고딕">
탈퇴 버튼을 누르면 바로 탈퇴가 진행됩니다.<Br>
그래도 탈퇴하시겠습니까?
</font></TD>
</TR><br>
...
<Input type='submit' value='탈퇴' method = 'post' >
</Form>
